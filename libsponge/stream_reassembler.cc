...
void StreamReassembler::handle_right_edge(std::pair<uint64_t, std::string>)
{
}
void StreamReassembler::handle_left_edge(std::pair<uint64_t, std::string>)
{
}

void StreamReassembler::handle_middle(std::pair<uint64_t, std::string>)
{
}
